    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('1', 'HOD'), ('2', 'Agent'), ('3', 'Customer')], default=1, max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plc_rate', models.IntegerField(blank=True, null=True)),
                ('plot_rate', models.FloatField(blank=True, null=True)),
                ('t_plot_amt', models.FloatField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plc_rate', models.IntegerField(blank=True, null=True)),
                ('Payable_amout', models.FloatField(blank=True, null=True)),
                ('payment_amount', models.FloatField(blank=True, null=True)),
                ('remaining_amount', models.FloatField(blank=True, default=0, null=True)),
                ...
                ('plot_number', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='matrixapp.addplot')),
            ],
        ),
        migrations.CreateModel(
            name='FundDetails',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mail', models.CharField(blank=True, max_length=50, null=True)),
                ('status', models.IntegerField(default=0)),
                ('name', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='matrixapp.bookplot')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='addplot',
            name='phase',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='matrixapp.phase'),
        ),
    ]
