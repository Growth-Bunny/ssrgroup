...
urlpatterns = [
    ...
    path('invoice/ticket/print',views.get_ticket, name="getticket"),
    ...
    path('preview_user',views.preview_user,name="preview_user"),
    ...
    path('userkyc/', HOD_Views.user_kyc,name="user_kyc"),
    ...
    path('plotno/View-phase2', HOD_Views.VIEWPhase2,name="view_phase2"),
    path('plotno/View-phase3', HOD_Views.VIEWPhase3,name="view_phase3"),
