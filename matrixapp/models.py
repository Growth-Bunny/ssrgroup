...
class SuperAgent(models.Model):
    ...
    ac_no = models.BigIntegerField(null=True,blank=True)
...
class AddPlot(models.Model):
    ...
    plot_size = models.FloatField(null=True,blank=True)
    plc_rate = models.IntegerField(default=0)
    # plc = models.IntegerField(null=True,blank=True)
    plot_rate = models.FloatField(default=0,null=True,blank=True)
    phase = models.ForeignKey(phase,on_delete=models.CASCADE,null=True,blank=True)
    t_plot_amt = models.FloatField(null=True,blank=True)
    total_amt = models.IntegerField(null=True,blank=True)
    receipt_Date = models.DateField(auto_now_add=True,null=True,blank=True)
...
class BookPlot(models.Model):
    ...
    # plot_number = models.ForeignKey(AddPlot,on_delete=models.CASCADE)
    plc_rate = models.FloatField(null=True,blank=True)
    # plot_number = models.CharField(max_length=25)
    Payable_amout = models.FloatField(null=True, blank=True)
    payment_amount = models.FloatField(null=True, blank=True)
    remaining_amount = models.FloatField(null=True, blank=True,default=0)    
    ...
    no_of_emi = models.PositiveIntegerField(null=True,blank=True)
    objects=models.Manager()
...
class Installment(models.Model):
    ...
    user_id = models.CharField(max_length=300)
    # user_id=models.CharField(primary_key=True,max_length=50, default=user_code, editable=False)
    plot_number = models.ForeignKey(AddPlot,on_delete=models.CASCADE,null=True, blank=True)
    Payable_amout = models.IntegerField(null=True, blank=True)
    ...
    # Mnthly_Installment = models.IntegerField(null=True, blank=True)
    # number_of_Installment = models.IntegerField(null=True,blank=True)
    # name = models.ForeignKey(BookPlot,on_delete=models.CASCADE,blank=True)
    # father_name = models.CharField(max_length=100,null=True,blank=True)
    mobile_no = models.BigIntegerField(null=True,blank=True)
    payment_mode = models.CharField(max_length=10,null=True,blank=True)
    remarks = models.TextField()
